...
import { SearchableItem, FloatingSearchWidget } from "../../common/floatingSearchWidget.component";
...
export const SearchTableNodesWidget = ({
    parentRef,
}: {
    ...
    return (
        <FloatingSearchWidget
            ...
            width="200px"
            emitSearchEvent={(searchText) => eventBus.emit("searchWidget", searchText)}
            parentRef={parentRef}
        />
    );
};
